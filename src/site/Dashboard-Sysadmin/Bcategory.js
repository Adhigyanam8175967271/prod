  ...
  axios.delete(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/deleteblogcategory/${clientId}`)
    ...
    return (
      ...
      <p className="mb-12 text-secondary-light" style={{fontSize:"15px"}}>
                                   <b>You are here</b>: <NavLink to="/dashboard" style={{color:'blueviolet', textDecoration:"underline"}}>Dashboard</NavLink> | Blog Categories
                               </p>
      ...
      <div className="auth-left py-32 px-24 d-flex flex-column" style={{background:"none",width:"auto"}}>
                    ...
                    <div>
                               ...
                               <p className="mb-32 text-secondary-light text-lg">
                                   Use the following form to add a new blog category to the website.<br/> <b>Recommended Resolution: 500 X 350</b>
                               </p>
