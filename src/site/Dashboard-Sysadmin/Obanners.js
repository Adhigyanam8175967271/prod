  ...
  axios.delete(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/deleteofferbanner/${clientId}`)
    ...
    return (
      ...
      <p className="mb-12 text-secondary-light" style={{fontSize:"15px"}}>
                                   <b>You are here</b>: <NavLink to="/dashboard" style={{color:'blueviolet'}}>Dashboard</NavLink> | Offer Banners
                               </p>
      ...
      <div className="auth-left py-32 px-24 d-flex flex-column" style={{background:"none"}}>
                    ...
                    <div>
                               ...
                               <p className="mb-32 text-secondary-light text-lg">
                                   Use the following form to add offer banners to the website.<br/> <b>Recommended Resolution: 600 X 350</b>
                               </p>
