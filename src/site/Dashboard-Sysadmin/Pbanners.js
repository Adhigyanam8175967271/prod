...
const handleDelete = (clientId) => {
  ...
  axios.delete(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/deleteprimarybanner/${clientId}`)
    .then(response => {
    ...
    return (
      ...
      <p className="mb-12 text-secondary-light" style={{fontSize:"15px"}}>
                                   <b>You are here</b>: <NavLink to="/dashboard" style={{color:'blueviolet', textDecoration:"underline"}}>Dashboard</NavLink> | Primary Banners
                               </p>
      ...
      <div className="auth-left py-32 px-24 d-flex flex-column" style={{background:"none",width:"auto"}}>
                    ...
                    <div>
                               ...
                               <p className="mb-32 text-secondary-light text-lg">
                                   Use the following form to add primary display banners to the website. You may leave the <b><i>Redirect URL as blank</i></b> in case no redirection is required.<br/> <b>Recommended Resolution: 1500 X 580</b>
                               </p>
