...
const Promocodes = () => {
  ...
  const fetchClients = () => {
    axios.get('https://adhigyanam-e92bf1bbbdb1.herokuapp.com/promocodes')
      .then(response => {
  ...
  axios
    .post(
      "https://adhigyanam-e92bf1bbbdb1.herokuapp.com/createpromo",
      { sno, title, dated },
    ...
    .catch((err) => {
      if (err.response && err.response.status === 409) {
        setMessageerror("Promocode already exists! Please choose another.");
      } else {
  ...
  const handleDelete = (clientId) => {
    ...
    axios.delete(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/deletepromo/${clientId}`)
      .then(response => {
