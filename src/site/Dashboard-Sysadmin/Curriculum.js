...
const fetchClients = (clientId) => {
  axios.get(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/curriculum/${clientId}`)
    .then(response => {
...
useEffect(() => {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post(
        'https://adhigyanam-e92bf1bbbdb1.herokuapp.com/createcurriculum',
        { sno, title, description, clientId },  // Sending as JSON
  ...
  const handleDelete = (clientId) => {
    ...
    axios.delete(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/deletecurriculum/${clientId}`)
      .then(response => {
      ...
      <MasterLayout>
        {/* Breadcrumb */}
         <p className="mb-12 text-secondary-light" style={{fontSize:"15px"}}>
                                           <b>You are here</b>: <NavLink to="/dashboard" style={{color:'blueviolet', textDecoration:"underline"}}>Dashboard</NavLink> | <NavLink to="/dashboardcourses" style={{color:'blueviolet', textDecoration:"underline"}}>Courses</NavLink>  | Curriculum
                                       </p>
     ...
     <div className="col-xxl-12 col-xl-12" style={{background:"none",width:"auto"}}>
         <div className="mx-auto w-100">
             <div>
                                           ...
                                           <p className="mb-32 text-secondary-light text-lg">
                                               <b>Use the following form</b><br/>to add a new curriculum record to the corresponding course.
                                           </p>
         ...
         <div className="mx-auto w-100">
             <div>
                               ...
                               <p className="mb-32 text-secondary-light text-lg">
                                   <b>Use the following datalist</b><br/>to modify / remove listed curriculum records.
                               </p>
