...
const Faq = () => {
  ...
  const fetchClients = () => {
    axios.get('https://adhigyanam-e92bf1bbbdb1.herokuapp.com/faq')
      .then(response => {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post(
        'https://adhigyanam-e92bf1bbbdb1.herokuapp.com/createfaq',
  ...
  const handleDelete = (clientId) => {
    ...
    axios.delete(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/deletefaq/${clientId}`)
      .then(response => {
      ...
      <MasterLayout>
        {/* Breadcrumb */}
         <p className="mb-12 text-secondary-light" style={{fontSize:"15px"}}>
                                           <b>You are here</b>: <NavLink to="/dashboard" style={{color:'blueviolet', textDecoration:"underline"}}>Dashboard</NavLink> | FAQs
                                       </p>
     ...
     <div className="col-xxl-12 col-xl-12" style={{background:"none",width:"auto"}}>
         <div className="mx-auto w-100">
             <div>
                                           ...
                                           <p className="mb-32 text-secondary-light text-lg">
                                               <b>Use the following form</b><br/>to add a new Frequently Asked Question to the website.
                                           </p>
         ...
         <div className="mx-auto w-100">
             <div>
                               ...
                               <p className="mb-32 text-secondary-light text-lg">
                                   <b>Use the following datalist</b><br/>to modify / remove listed FAQs.
                               </p>
  ...
  <tbody>
    {clients.map(client => (
      <tr key={client.Id} style={{ borderBottom: "1px solid #ddd", backgroundColor: "#f9f9f9", transition: "0.3s" }}>
        ...
        <td style={{ padding: "10px", fontSize: "0.9rem", color: "#333", backgroundColor:"white" }}>{client.Jobtitle}<b><br/>{client.Named}</b></td>
