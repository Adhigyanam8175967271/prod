...
const fetchClients = () => {
  axios.get('https://adhigyanam-e92bf1bbbdb1.herokuapp.com/secondarybanners')
    .then(response => {
...
const handleDelete = (clientId) => {
  ...
  axios.delete(`https://adhigyanam-e92bf1bbbdb1.herokuapp.com/deletesecondarybanner/${clientId}`)
    .then(response => {
